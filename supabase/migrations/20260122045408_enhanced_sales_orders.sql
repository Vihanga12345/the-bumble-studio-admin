...
RAISE NOTICE '✅ Enhanced Sales Orders schema update completed successfully!';
RAISE NOTICE '📋 New features:';
RAISE NOTICE '  - Manual customer entry (name, address, telephone)';
RAISE NOTICE '  - Discount percentage and amount calculation';
RAISE NOTICE '  - Advance payment (default 50%) calculation';
RAISE NOTICE '  - Order status tracking (Order Confirmed → Advance Paid → Crafted → Delivered → Full Payment Done)';
RAISE NOTICE '  - PDF generation support';
RAISE NOTICE '  - Subtotal, discount, and remaining balance tracking';
